    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <section id="jumbotron" class="jumbotron-fluid background-jumbotron">
        <div class="container-fluid py-5 text-center">
          <p class="p-3"></p>
          <h1 class="display-3">Konsultasi Masalah Kucing Anda</h1>
            <p>Hubungi Kami</p>
        </div>
      </section>
      ...
      <div class="container1">
        <div class="row">
          <div class="col-md text-center">
            <img src="gambar/logo.png" width="100" alt="Logo" class="avatar"
            style="
              width: 50px;
              height: 50px;
              border-radius: 50%";
          > 
            ...
            <ul class="list-group list-group-flush lead" style="text-align: center;">
              <li class="list-group-item">
                <span class="fw-bold">Alamat:</span> Jl. Bhineka
              </li>
              <li class="list-group-item">
                <span class="fw-bold">No. HP:</span> +62 822-9044-6984
              </li>
              <li class="list-group-item">
                <span class="fw-bold">Email:</span> catalogspareparthp@gmail.com
              </li>
            </ul>
          </div>
        </div>
